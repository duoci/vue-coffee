  ...
  export default {
    ...
    methods: {
      ...
      async getMyData() {
        ...
        if (code === 'A001') this.userInfo = userInfo;
        if (code === 700) this.$router.push({ name: 'Login' });
      },
...
<style lang="less" scoped>
  .my {
    ...
    .my-box {
      ...
      background-image: linear-gradient(to bottom, rgba(255, 255, 255, 0.5) 0px, rgba(255, 255, 255, 0.5) 35px, rgba(255, 255, 255, 1) 35px);
    }
  }
</style>
